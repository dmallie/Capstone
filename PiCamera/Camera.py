...
class VideoFeedback():
    ...
    def movingAverage(self, similarityIndex):
        if self.X2 == 1:
            ...
            #print("self.noFrame: ", self.noFrame)
    ...
    def similarityAverage(self, similarityIndex):
        if self.X2 == 1:
            for index in range(self.windowLength-1):
    ...
    def ObjectFinder(self):
        self.average = np.mean(self.window)
        self.average = round(self.average,0)
        if (self.average >= self.thresholdValue) and (self.average <= (self.thresholdValue + 50)):
            self.X3 = 2
            self.X1 = 1
            self.X2 = 1
    ...
    def Recording(self,picture):
        ...
        print("Collected Garbage: ", collected, " objects")
        ...
        for frame in self.stream:
            ...
            stopTime = time.time()
            #print("frame Duration: ", stopTime - startTime)
